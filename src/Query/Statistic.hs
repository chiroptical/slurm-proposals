...
-- getStatistics ::
--      MonadBeam Sqlite m => Text -> m (Either DatabaseError [Statistic])
...
--      MonadBeam Sqlite m
--   => Text
--   -> m (Either DatabaseError (Account_, [Statistic_]))
...
--         pure statistic
-- getStatisticById ::
--      MonadBeam Sqlite m => Int -> m (Either DatabaseError Statistic)
-- getStatisticById = (fmap . fmap) toStatistic . getStatisticById_
-- getStatisticById_ ::
--      MonadBeam Sqlite m => Int -> m (Either DatabaseError (Account_, Statistic_))
