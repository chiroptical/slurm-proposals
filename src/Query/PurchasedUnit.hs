...
-- getPurchasedUnits ::
--      MonadBeam Sqlite m => Text -> m (Either DatabaseError [PurchasedUnit])
...
--      MonadBeam Sqlite m
--   => Text
--   -> m (Either DatabaseError (Account_, [PurchasedUnit_]))
...
--      MonadBeam Sqlite m => Int -> m (Either DatabaseError PurchasedUnit)
